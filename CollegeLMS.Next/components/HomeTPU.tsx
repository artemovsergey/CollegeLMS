      ...
      <section className="app-section">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-tpu-blue-light px-4 py-1.5 text-xs font-semibold text-tpu-blue">
              Государственное бюджетное профессиональное образовательное учреждение
            </div>
            <h2 className="mb-4 text-3xl lg:text-4xl font-bold text-tpu-text leading-tight">
              Ставропольский колледж связи<br />
              имени Героя Советского Союза В.А. Петрова
            </h2>
            <p className="text-base leading-relaxed text-tpu-text-secondary max-w-3xl mx-auto">
      ...
      <section className="app-section app-section--alt">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="mb-12 text-center">
            <h2 className="app-section__title">Обратная связь</h2>
