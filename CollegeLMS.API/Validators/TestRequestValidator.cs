...
public class CreateTestRequestValidator : AbstractValidator<CreateTestRequest>
{
    public CreateTestRequestValidator()
    {
        RuleFor(x => x.Title)
            ...
            .MaximumLength(255)
            .WithMessage("Название теста не должно превышать 255 символов");
        RuleFor(x => x.TimeLimitMinutes)
            .GreaterThan(0)
            .WithMessage("Время на прохождение должно быть больше 0");
...
public class CreateQuestionRequestValidator : AbstractValidator<CreateQuestionRequest>
{
    public CreateQuestionRequestValidator()
    {
        RuleFor(x => x.Text)
            ...
            .MaximumLength(4000)
            .WithMessage("Текст вопроса не должен превышать 4000 символов");
...
public class AssignTestRequestValidator : AbstractValidator<AssignTestRequest>
{
    public AssignTestRequestValidator()
    {
        ...
        RuleFor(x => x.CloseDate)
            .NotEmpty()
            .WithMessage("Дата закрытия обязательна")
