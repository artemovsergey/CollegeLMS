...
public interface ICourseService
{
    ...
    Task<Result<List<CourseGroupResponse>>> GetCourseGroupsAsync(
        Guid courseId,
        CancellationToken ct = default
    );
    Task<Result> RemoveGroupAsync(
        Guid courseId,
        Guid groupId,
        Guid currentUserId,
        string currentUserRole,
    ...
    Task<Result<CourseProgressResponse>> GetProgressAsync(
        Guid courseId,
        Guid currentUserId,
        CancellationToken ct = default
    );
