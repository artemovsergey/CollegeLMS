        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <a href="mailto:college@stvcc.ru" className="hover:text-primary transition-colors">
                  college@stvcc.ru
                </a>
              </li>
            </ul>
          ...
          <div>
            <h3 className="mb-3 text-sm font-semibold text-foreground">Учредитель</h3>
            <p className="text-sm leading-relaxed text-muted-foreground">
              Министерство энергетики, промышленности и связи Ставропольского края
            </p>
            <h3 className="mb-3 mt-6 text-sm font-semibold text-foreground">Мы в соцсетях</h3>
            <div className="flex gap-3">
              <a
                href="https://vk.com/stvcc_official"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full border border-border text-muted-foreground transition-colors hover:border-[#0077FF] hover:text-[#0077FF] hover:bg-[#0077FF]/5"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full border border-border text-muted-foreground transition-colors hover:border-[#08C] hover:text-[#08C] hover:bg-[#08C]/5"
                aria-label="Telegram"
              >
                <svg width="20" height="20" viewBox="0 0 35 37" fill="currentColor">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full border border-border transition-colors hover:border-[#471AFF] hover:bg-[#471AFF]/5"
                aria-label="Max"
              >
          ...
          <div>
            <h3 className="mb-3 text-sm font-semibold text-foreground">О колледже</h3>
            <p className="text-sm leading-relaxed text-muted-foreground">
