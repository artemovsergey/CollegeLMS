...
public class SpecialtyControllerTests : BaseIntegrationTest
{
    ...
    public async Task GetAll_ReturnsOkWithList()
    {
        ...
        var body = await DeserializeAsync<Result<List<SpecialtyResponse>>>(response);
        Assert.NotNull(body);
    ...
    public async Task GetById_ReturnsNotFound_WhenMissing()
    {
        ...
        var response = await Client.GetAsync($"/api/specialties/{Guid.NewGuid()}");
